...
export async function POST(req) {
  ...
  if (body.noshow) {
    console.log("no show!");
    let resp = await sql`
      INSERT INTO champs2025 (ScoutName, ScoutTeam, Team, Match, MatchType, NoShow)
  ...
  let resp = await sql`
    ...
    VALUES (
      ...
      ${body.endlocation}, ${body.coralspeed}, ${body.processorspeed}, ${body.netspeed}, ${body.algaeremovalspeed}, 
