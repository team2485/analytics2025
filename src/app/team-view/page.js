              ...
              <h4 className={styles.graphTitle}>Piece Placement</h4>
                ...
                <div className={styles.valueBoxes}>
                  <div className={styles.leftColumnBoxes}>
                    <VBox className={styles.box1} color1={Colors[0][1]} color2={Colors[0][0]} title={"Matches Scouted"} value={data.matchesScouted} />
                    <VBox className={styles.box2} color1={Colors[0][1]} color2={Colors[0][0]} title={"No Show"} value={data.noShow} />
                    <VBox className={styles.box3} color1={Colors[0][1]} color2={Colors[0][0]} title={"Defense"} value={data.defense} />
                    <VBox className={styles.box4} color1={Colors[0][1]} color2={Colors[0][0]} title={"Consistency"} value={data.consistancy} />
                    <VBox className={styles.box5} color1={Colors[0][1]} color2={Colors[0][0]} title={"Breakdown"} value={data.breakdown} />
                    <VBox className={styles.box6} color1={Colors[0][1]} color2={Colors[0][0]} title={"Last Breakdown"} value={data.lastBreakdown} />
