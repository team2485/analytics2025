            ...
            <div className={styles.leftColumn}>
                ...
                <div className={styles.valueBoxes}>
                  <div className={styles.leftColumnBoxes}>
                    ...
                    <VBox id="box" className={styles.boxes} style={{width: "200px"}} color1={Colors[0][1]} color2={Colors[0][0]} title={"No Show"} value={`${Math.round(1000*data.noShow)/10}%`}/>
          ...
          <div className={styles.alignElements}>
              <div className={styles.valueBoxes}>
                <div className={styles.rightColumnBoxes}>
                  <VBox color1={Colors[1][2]} color2={Colors[1][0]} color3={Colors[1][2]} title={"Leave"} value={`${Math.round(1000*data.leave)/10}%`}/>
              </div>
